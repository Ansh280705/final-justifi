              ...
              <div className="flex flex-col items-center text-center">
                ...
                >
                  {lawyer.practiceArea} {lawyer.qualifications && lawyer.qualifications.length > 0 && (
                    <span className="block text-[10px] opacity-80 mt-0.5 font-medium italic">({lawyer.qualifications.join(", ")})</span>
                  )}
                </Badge>
                ...
                <div className="flex items-center justify-center p-2.5 bg-emerald-50/80 border border-emerald-100 rounded-xl mb-2">
                  ...
                  <span className="text-sm font-bold text-slate-700">
                    {lawyer.experience} Years of Expertise
                  </span>
                </div>
              ...
              <CardContent className="space-y-6">
                {totalSlots > 0 ? (
                  ...
                  <div className="text-center py-6">
                    ...
                    <p className="text-muted-foreground">
                      This lawyer doesn&apos;t have any available consultation
