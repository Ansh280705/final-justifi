...
export default function ContactPage() {
  ...
  const handleSubmit = async () => {
    ...
    // Robust email check (matching Zod email schema logic)
      ...
      <div className="container mx-auto px-6 lg:px-20">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground mt-2 max-w-xl mx-auto">
            Have questions about legal consultations, case management, or
            appointments? Our Justifi team is here to help you.
          </p>
        </div>
          ...
          <Card className="lg:col-span-2">
            ...
            <CardContent className="grid md:grid-cols-2 gap-6 text-sm">
              <div>
                ...
                <p className="text-client mt-1 font-medium">Justifi AI</p>
              </div>
              <div>
                <h4 className="font-semibold text-foreground">
                  Firm Name
                </h4>
                <p className="text-client mt-1 font-medium">Justifi Legal Solutions</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-client mt-1">JustifiOfficial@gmail.com</p>
              </div>
