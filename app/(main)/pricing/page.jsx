  ...
  return (
    <div className="container mx-auto px-4 mt-5 h-full w-full">
      ...
      <div className="max-w-full mx-auto mb-12 text-center">
        ...
        All payments made on Justifi are for software platform usage, subscription
        access, and digital tools provided by the platform. Justifi does not collect
        fees for legal or professional advice.
      </div>
      ...
      <div className="max-w-3xl mx-auto mt-16 text-center">
        ...
        <p className="text-muted-foreground mb-4">
          Contact our support team at JustifiOfficial@gmail.com
        </p>
      </div>
    </div>
  );
