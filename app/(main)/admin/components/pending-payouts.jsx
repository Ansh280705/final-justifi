          ...
          <DialogContent className="max-w-2xl w-[95vw] max-h-[90vh] max-h-[90dvh] flex flex-col p-0 overflow-hidden bg-white border-none shadow-2xl">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 min-h-0">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-black font-semibold">Lawyer Information</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-slate-50 p-4 rounded-xl border border-slate-100">
                  <div>
                    ...
                    <p className="text-black font-medium text-sm">
                      {selectedPayout.lawyer?.name || "Unknown"}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider">
                  ...
                  <div>
                    ...
                    <p className="text-black font-medium text-sm">
                      {selectedPayout.lawyer?.practiceArea || "—"}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider">
              ...
              {(selectedPayout.lawyer?.credits ?? 0) <
                selectedPayout.credits && (
                  <Alert variant="destructive" className="bg-red-50 border-red-100">
                    <AlertCircle className="h-4 w-4" />
                    <AlertDescription className="text-xs">
                      <strong>Critical Warning:</strong> Lawyer has only{" "}
                      {selectedPayout.lawyer?.credits ?? 0} credits but this
            ...
            <DialogFooter className="p-6 border-t shrink-0 flex flex-col sm:flex-row-reverse gap-3 bg-white">
              <Button
                ...
                disabled={
                  (selectedPayout.lawyer?.credits ?? 0) < selectedPayout.credits
                }
