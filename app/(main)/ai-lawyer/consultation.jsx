...
export default function AIConsultation() {
  const t = useTranslations("LawyerAI");
  ...
  const [lang, setLang] = useState(locale === "en" ? "en-IN" : locale === "hi" ? "hi-IN" : "mr-IN");
  ...
  const restart = () => {
    ...
    setStageIndex(0);
    setInterimText("");
    if (voiceEnabled) speak(initialMessage.content, { lang });
  };
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-teal-400 text-xs mt-0.5">
                {isLoading ? t("thinking") : isSpeaking ? t("speaking") : isListening ? t("listening") : t("legalNotification")}
              </p>
            </div>
          </div>
