...
import { deleteAvailability, setAvailabilitySlots } from '@/actions/lawyer';
  ...
  return (
    <Card className="border-emerald-900/20">
      <CardHeader>
        ...
        <CardDescription>
          Set your daily availability for client cases
        </CardDescription>
      </CardHeader>
      <CardContent>
            ...
            <div className="mb-6">
              ...
              {slots.length === 0 ? (
                <p className="text-muted-foreground">
                  ...
                  availability to start accepting cases.
                </p>
              ) : (
        ...
        <div className="mt-6 p-4 bg-muted/10 border border-emerald-900/10 rounded-md">
          ...
          <p className="text-muted-foreground text-sm">
            Setting your daily availability allows clients to book cases
