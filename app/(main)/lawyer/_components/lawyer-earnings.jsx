...
export function LawyerEarnings({ earnings, payouts = [] }) {
  ...
  const handlePayoutRequest = async (e) => {
    ...
    if (!paypalEmail) {
      toast.error("Withdrawal account details are required");
      return;
    }
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  ₹{availablePayout.toFixed(2)} available for withdrawal
                </p>
              </div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-muted/20 p-4 rounded-lg border border-emerald-900/20">
            ...
            {pendingPayout ? (
              <div className="space-y-2">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                  ...
                  <div>
                    <p className="text-muted-foreground">UPI / Bank Account</p>
                ...
                <Alert>
                  ...
                  <AlertDescription className="text-sm">
                    Your withdrawal request is being processed. You'll receive the
                    payment once verified. Your credits will be
            ...
            {!pendingPayout && availableCredits > 0 && (
              ...
              >
                Request Withdrawal for All Credits
              </Button>
            )}
            ...
            {availableCredits === 0 && !pendingPayout && (
              <div className="text-center py-4">
                <p className="text-muted-foreground">
                  No credits available for withdrawal. Complete more cases to
                  earn credits.
                </p>
              </div>
            )}
          ...
          <Alert>
            ...
            <AlertDescription className="text-sm">
              ...
              Platform fee is ₹2 per credit. Withdrawals include all your available
              credits and are processed via UPI or Bank Transfer.
            </AlertDescription>
          </Alert>
          ...
          {payouts.length > 0 && (
            <div className="space-y-2">
              <h3 className="text-lg font-medium text-white">Withdrawal History</h3>
              <div className="space-y-2">
      ...
      <Dialog open={showPayoutDialog} onOpenChange={setShowPayoutDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Withdraw all your available credits to your bank account or UPI
            </DialogDescription>
          </DialogHeader>
          ...
          <form onSubmit={handlePayoutRequest} className="space-y-4">
            <div className="bg-muted/20 p-4 rounded-lg space-y-2">
              ...
              <div className="border-t border-emerald-900/20 pt-2 flex justify-between font-medium">
                <span className="text-black">Net withdrawal:</span>
            ...
            <div className="space-y-2">
              <Label htmlFor="withdrawalAccount">UPI ID / Bank Details</Label>
              <Input
              ...
              />
              <p className="text-sm text-muted-foreground">
                Enter where you want to receive the funds.
              </p>
            </div>
            ...
            <Alert>
              <AlertCircle className="h-4 w-4" />
              <AlertDescription className="text-sm">
                Once approved, {availableCredits} credits will be
                deducted from your account and ₹{availablePayout.toFixed(2)}{" "}
                will be sent to your specified account.
              </AlertDescription>
            </Alert>
