...
import { Calendar, Clock, DollarSign, BrainCircuit } from "lucide-react";

export function LawyerTabsSection({ children }) {
  ...
  const triggers = [
    ...
    { value: "sessions", label: "Cases", icon: Calendar },
    { value: "availability", label: "Availability", icon: Clock },
    { value: "specialized", label: "Specialized Referrals", icon: BrainCircuit },
  ];
          ...
          return (
            ...
            >
              {activeTab === trigger.value && (
                <motion.div
                  layoutId="lawyer-active-tab-highlight"
