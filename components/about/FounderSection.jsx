        ...
        <div className="container mx-auto px-6 lg:px-20 space-y-24">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                With deep expertise in technology and system architecture, Er. Pankaj Chourasiya is the backbone of Justifi's digital framework. He leads platform development, workflow automation, and system scalability—ensuring Justifi remains robust, user-friendly, and future-ready for India’s growing digital needs.
              </p>
