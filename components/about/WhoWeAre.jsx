  ...
  return (
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-6 lg:px-20">
        ...
        <p className="mb-6">
          Justifi is a software-as-a-service (SaaS) platform that provides appointment
        ...
        <p>
          Justifi does not provide medical services or professional advice and does not
      ...
      <div className="container mx-auto px-6 lg:px-20 mt-8 pt-6 border-t border-border/20 text-xs text-muted-foreground text-center">
         <p>Justifi is a technology platform and does not provide professional consultation, diagnosis, or advice. All services are provided independently by professionals using the platform.</p>
      </div>
    </section>
  );
}
