        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
          ...
          <div className="flex-1 w-full text-center sm:text-left">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-3">
              <h3 className="font-extrabold text-client text-xl tracking-tight leading-none group-hover:text-emerald-700 transition-colors">{lawyer.name}</h3>
              <Badge
                variant="outline"
            ...
            <div className="space-y-2 mb-5">
              ...
              <div className="flex items-center justify-center sm:justify-start text-xs text-slate-500 font-medium pb-2 border-b border-slate-50">
                ...
                <span>{lawyer.experience} Successful Years</span>
              </div>
            </div>
            ...
            >
              <Link href={`/lawyers/${encodeURIComponent(lawyer.practiceArea)}/${lawyer.id}`}>
