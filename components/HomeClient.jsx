          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1 text-center lg:text-left z-10">
              ...
              <h1 className="text-6xl lg:text-[88px] font-black text-navy tracking-tighter leading-[0.92] mb-8">
                <TextReveal text={t("heroTitle1")} delay={0.2} />
                <br />
                <TextReveal text={t("heroTitle2")} delay={0.5} />
                <br />
                <span className="text-emerald-500">
                  <TextReveal text={t("heroTitle3")} delay={0.8} />
                </span>
              </h1>
      ...
      <section className="py-32 bg-[#fafafa] relative">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <ScrollReveal className="text-center max-w-3xl mx-auto mb-24">
            <h3 className="text-4xl lg:text-5xl font-black text-navy tracking-tight mb-8">
              <WordReveal text={t("howItWorksTitle")} />
            </h3>
            <p className="text-lg text-slate-500 font-medium">{t("howItWorksSub")}</p>
          </ScrollReveal>
          ...
          <ScrollReveal className="flex flex-col lg:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-xl">
              <h3 className="text-4xl lg:text-5xl font-black text-navy tracking-tight mb-6">
                <WordReveal text={t("disputeCategoriesTitle")} />
              </h3>
              <p className="text-lg text-slate-500 font-medium">{t("disputeCategoriesSub")}</p>
            </div>
            ...
            <div className="grid lg:grid-cols-4 gap-16 mb-24">
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li><Link href="/blog" className="text-slate-400 hover:text-emerald-400 font-medium transition-colors">Legal Notification</Link></li>
